#ifndef AUDIOSINK_IMPL_BASE_H
#define AUDIOSINK_IMPL_BASE_H
...
class AudioSink_base : public Resource_impl
{
    friend class BULKIO_dataShort_In_i;

    public: 
        AudioSink_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<AudioSink_base> *serviceThread; 
