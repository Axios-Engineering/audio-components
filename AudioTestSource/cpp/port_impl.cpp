/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Sun Apr 21 01:22:34 BST 2013
 	REDHAWK IDE
 	Version: R.1.8.3
...
// ----------------------------------------------------------------------------------------
BULKIO_dataShort_Out_i::BULKIO_dataShort_Out_i(std::string port_name, AudioTestSource_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<AudioTestSource_i *> (_parent);
