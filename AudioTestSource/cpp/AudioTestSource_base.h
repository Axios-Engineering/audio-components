#ifndef AUDIOTESTSOURCE_IMPL_BASE_H
#define AUDIOTESTSOURCE_IMPL_BASE_H
...
class AudioTestSource_base : public Resource_impl
{
    friend class BULKIO_dataShort_Out_i;

    public: 
        AudioTestSource_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<AudioTestSource_base> *serviceThread; 
        boost::mutex serviceThreadLock;  

        // Member variables exposed as properties
        unsigned short waveform;
        CORBA::ULong frequency;
        bool is_live;
        CORBA::ULong samplesperpacket;
        double volume;
        CORBA::ULong sample_rate;
        CORBA::ULong resample_filter_length;
        unsigned short resample_quality;
        std::string stream_id;

        // Ports
        BULKIO_dataShort_Out_i *audio_out;
