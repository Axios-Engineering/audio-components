#ifndef AUDIOSOURCE_IMPL_BASE_H
#define AUDIOSOURCE_IMPL_BASE_H
...
class AudioSource_base : public Resource_impl
{
    friend class BULKIO_dataShort_Out_i;

    public: 
        AudioSource_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<AudioSource_base> *serviceThread; 
        boost::mutex serviceThreadLock;  

        // Member variables exposed as properties
        std::string audio_uri;
        CORBA::Long loop_count;
        CORBA::ULong output_sample_rate;
        double volume;
        bool mute;
