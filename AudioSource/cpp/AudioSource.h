 ...
 */
#ifndef AUDIOSOURCE_IMPL_H
#define AUDIOSOURCE_IMPL_H
...
class AudioSource_i : public AudioSource_base
{
    ENABLE_LOGGING
    public: 
        AudioSource_i(const char *uuid, const char *label);
        ~AudioSource_i();
	...
	private:
		...
		static void _new_gst_buffer(GstElement *sink, AudioSource_i *comp);
};
