...
pushd cpp
./reconf
%define _bindir %{_prefix}/dom/components/AudioSource/cpp
%configure
make
popd
...
%{_prefix}/dom/components/%{name}/AudioSource.spd.xml
%{_prefix}/dom/components/%{name}/AudioSource.prf.xml
%{_prefix}/dom/components/%{name}/AudioSource.scd.xml
